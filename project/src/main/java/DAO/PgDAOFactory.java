...
public class PgDAOFactory extends DAOFactory {
  ...
  public RodoviaDAO getRodoviaDAO(){return new PgRodoviaDAO(this.connection);}
  public SentidoRodoviaDAO getSentidoRodoviaDAO(){return new PgSentidoRodoviaDAO(this.connection);}
  public TipoAcidenteDAO getTipoAcidenteDAO(){return new PgTipoAcidenteDAO(this.connection);}
  public TipoOcorrenciaDAO getTipoOcorrencia(){return new PgTipoOcorrenciaDAO(this.connection);}
  public TipoPistaDAO getTipoPistaDAO(){return new PgTipoPistaDAO(this.connection);}
  public TrechoRodoviaDAO getTrechoRodoviaDAO(){return new PgTrechoRodoviaDAO(this.connection);}
  public UltrapassagemDAO getUltrapassagemDAO(){return new PgUltrapassagemDAO(this.connection);}
